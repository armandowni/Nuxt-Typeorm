  ...
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">Welcome to the project</h2>
        <p class="mt-3 text-gray-600">
          ...
          <a href="https://nuxtjs.org" target="_blank" class="button--doc text-green-500 hover:underline">Nuxt
            documentation</a>, whether you are new or have previous experience with nuxt
          framework.<br />
        </p>
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the
          <a href="https://expressjs.com/" target="_blank" class="button--doc text-blue-500 hover:underline">Express
            documentation</a>, whether you are new or have previous experience with express
          framework.<br />
        </p>
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the
          <a href="https://typeorm.io/" target="_blank" class="button--doc text-red-500 hover:underline">Typeorm
            documentation</a>, whether you are new or have previous experience with Typeorm
          framework.<br />
        </p>
