    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        ...
        <p class="mt-3 text-gray-600">
          ...
          >, whether you are new or have previous experience with nuxt
          framework.<br />
        </p>
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the
          <a
            ...
            target="_blank"
            class="button--doc text-blue-500 hover:underline"
            >Express documentation</a
          >, whether you are new or have previous experience with express
          framework.<br />
        </p>
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the
          <a
            ...
            target="_blank"
            class="button--doc text-red-500 hover:underline"
            >Typeorm documentation</a
          >, whether you are new or have previous experience with Typeorm
          framework.<br />
        </p>
